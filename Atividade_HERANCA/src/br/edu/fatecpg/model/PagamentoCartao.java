...
public class PagamentoCartao implements Pagamento{
	...
	public PagamentoCartao(float pagamento) {
	...
	public void calcularPagamento(){
		this.pagamento_dc = ((pagamento * this.dc)/ pagamento) + pagamento;
		System.out.println("Valor a ser pago: " + formatDouble(this.pagamento));
		System.out.println("Valor a ser pago: " + formatDouble(this.pagamento_dc) + " com taxa de 5%");
	}
	@Override
